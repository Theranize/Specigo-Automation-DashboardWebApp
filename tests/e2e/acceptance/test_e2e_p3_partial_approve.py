"""E2E P3: Partial pipeline — phlebo 3 samples, accession accepts 2, LT processes 1, doctor approves."""
...
_TEST = "test_e2e_p3_partial_approve"
...
def _shot(page, label: str) -> str:
    ...
    path = f"artifacts/p3_{label}.png"
...
def test_e2e_p3_partial_approve(page, login_as):
    """P3: Partial pipeline — phlebo toggles 3/4 samples, accession accepts 2, LT saves 2 tests, doctor approves."""
    ...
    # ── Phase 2: Phlebotomist (3 of 4 samples toggled ON) ───
    ...
    # ── Phase 3: Accession (accept WB + Serum only) ──────────
    login_as("accession")
    ...
    # ── Phase 4: Lab Technician (accept Serum, save RFT + LFT)
    ...
    # ── Phase 5: Doctor (approve RFT + LFT) ─────────────────
    login_as("doctor")
