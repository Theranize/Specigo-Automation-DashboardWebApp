"""E2E Acceptance flow: FD → Phlebotomist → Accession → LabTech → Doctor."""
...
def _shot(page, label: str) -> str:
    ...
    path = f"artifacts/acceptance_{label}.png"
...
def test_e2e_acceptance(page, login_as):
    """Full acceptance flow: register → collect → verify → report → review."""
